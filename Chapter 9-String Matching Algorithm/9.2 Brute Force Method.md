...
![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.1.png)

And we have to search the following pattern:
![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.2.png)

## Working of Brute Force Method

To find the required pattern, we align the pattern with the same length at the beginning of the text.

![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.3.png)
...
![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.4.png)

As "C" and "C" match, we now check for the second character.

![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.5.png)
...
![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.6.png)
...
![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.7.png)

Here, "D" and "C" don't match. So, we move on to the next character.

![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.8.png)

Here, "E" and "C" don't match. So, we move on to the next character.

![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.9.png)

Here, "W" and "C" don't match. So, we move on to the next character.
![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.10.png)

Here, "I" and "C" don't match. So, we move on to the next character.
![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.11.png)

Here, "T" and "C" don't match. So, we move on to the next character.

![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.12.png)

Here, "H" and "C" don't match. So, we move on to the next character.

![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.13.png)
Here, the pattern matches the substring of our text. However, we continue our search.

![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.14.png)
...
![img](https://cdn.programiz.pro/course-images/dsa-with-python/dsa-9.2.15.png)
